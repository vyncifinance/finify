...
export default function MetasPage() {
  ...
  function abrirAporte(meta: any) {
    setMetaSelecionada(meta); setValorAporte(''); setAporteOpen(true)
  }
        ...
        <div className="fixed inset-0 z-50 flex items-end lg:items-center justify-center"
          ...
          <div className="w-full lg:max-w-md rounded-t-[28px] lg:rounded-[20px] p-6 max-h-[92vh] overflow-y-auto"
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={() => setModalOpen(false)} style={{ color: '#94A3B8' }}><X size={20} strokeWidth={2} /></button>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              {ICONES.map(ic => (
                <button key={ic.nome} onClick={() => setIcone(ic.nome)}
                  ...
                  style={{ borderColor: icone === ic.nome ? cor : '#E2E8F0', backgroundColor: icone === ic.nome ? cor + '12' : '#fff', borderWidth: icone === ic.nome ? 2 : 1 }}>
        ...
        <div className="fixed inset-0 z-50 flex items-end lg:items-center justify-center"
          ...
          <div className="w-full lg:max-w-sm rounded-t-[28px] lg:rounded-[20px] p-6"
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={() => setAporteOpen(false)} style={{ color: '#94A3B8' }}><X size={20} strokeWidth={2} /></button>
            </div>
        ...
        <div className="px-4 flex flex-col gap-3">
          {loading ? (
            ...
            <div className="rounded-2xl border flex flex-col items-center justify-center py-12 gap-3"
              ...
              <button onClick={abrirModal} className="text-sm font-semibold" style={{ color: '#0F766E' }}>
                Criar primeira meta →
              </button>
            </div>
          ) : metas.map(m => {
            ...
            return (
              <div key={m.id} className="rounded-2xl border p-4"
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="px-2 py-1 rounded-lg flex-shrink-0" style={{ backgroundColor: cor + '18' }}>
