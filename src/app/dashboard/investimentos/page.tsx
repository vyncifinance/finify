...
export default function InvestimentosPage() {
  ...
  const [novoAporteData, setNovoAporteData]         = useState(() => dataLocalISO(new Date()))
  ...
  const [dataAplicacao, setDataAplicacao]           = useState(() => dataLocalISO(new Date()))
  ...
  function abrirNovaPosicao() {
    ...
    setDataAplicacao(dataLocalISO(new Date()))
    setValorAtualManual('')
    setTicker('')
    setQuantidade('')
    setPrecoUnitario('')
  ...
  function abrirAportes(p: any) {
    setPosicaoAportes(p)
    setNovoAporteValor('')
    setNovoAporteData(dataLocalISO(new Date()))
