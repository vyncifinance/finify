      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-16"
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider mb-2"
                style={{ color: '#6B7280' }}>E-mail</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider mb-2"
                style={{ color: '#6B7280' }}>Senha</label>
            ...
            <button type="button" onClick={handleEsqueceuSenha}
              className="self-end text-sm font-semibold -mt-2 hover:underline"
              style={{ color: '#0E3B2E' }}>
              Recuperar acesso
            </button>
          ...
          <p className="text-center text-sm" style={{ color: '#6B7280' }}>
            ...
            <a href="/cadastro" className="font-bold hover:underline" style={{ color: '#0E3B2E' }}>
              Criar conta
            </a>
          </p>
