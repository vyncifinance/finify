...
// pro mesmo formato de comparação usado com CDI/IPCA. Usa os últimos 3 meses de
// fechamentos diários (range=3mo&interval=1d — combinação documentada e testada
// pela brapi; interval mensal deu 400 Bad Request em índices como ^BVSP).
